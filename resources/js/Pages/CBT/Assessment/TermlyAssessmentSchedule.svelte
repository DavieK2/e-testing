<script>
    ...
    let step = {
        step : 3,
        stepOneUrl: '/assessments/termly?assessmentId='+$page.props.assessmentId,
        stepTwoUrl: '/assessments/termly/classes/'+$page.props.assessmentId,
        placeholder : "Assessment Schedule"
    }
