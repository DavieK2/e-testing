<script>
    ...
    import QuestionsList from "../../../Teacher/components/questions_list.svelte";
    import QuestionsBank from "../../../Teacher/components/questions_bank.svelte";
...
<Layout >
    <div class="relative mt-20 overflow-x-auto">
        ...
        <div class="fixed ml-56 mt-16 z-30 inset-x-0 flex border-b items-center h-16 bg-white">
             <div class="flex flex-col justify-center px-8 w-[36rem] shrink-0 border-r h-full">
                  <p class="font-bold text-gray-700">Add New Question</p>
             </div>
             <div class="px-8 py-4 w-[calc(100vw-50rem)] space-x-10 flex items-center justify-between">
                ...
                <div class="h-full w-full">
                    <div class="flex items-center h-full">
                        ...
                        <button on:click={ () => questionType = QuestionsBank } type="button" class={`text-xs py-2.5 px-8 ${ questionType != QuestionsBank ? 'text-gray-400 bg-gray-100' : 'text-gray-600 border-2 border-gray-500' } rounded-e-lg transition min-w-max  w-full font-semibold`}>Question Bank</button> 
                    </div>      
                </div>
