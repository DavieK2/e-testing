<script>
    ...
    const assignClasses = () => {
        ...
        router.post('/api/assessment/assign-classes', { assessmentId, classes : selectedClasses, step : 'add_classes' }, {
        ...
        <div class="mx-auto max-w-4xl">
            <div class="flex items-center justify-between my-2 border-b border-gray-50 pb-8">
                ...
                <div class="ml-72 pt-4 max-w-3xl">
                    <Button on:click={ assignClasses } buttonText={ assessmentId ? "Update & Continue" : "Save & Continue"} className="px-6 min-w-max" />
                </div>
            </div>
                    ...
                    <div class="w-full space-y-6">
                        ...
                        { #each classes as grade }
                            <div class="flex space-x-2 items-center w-full">
                                ...
                                <div class="w-full">
                                    <button type="button" class={`flex p-3 border ${ isSelected(grade.class_code) ? 'border-green-700' : 'border-gray-300' }  w-full rounded-lg items-center justify-between space-x-2`}>
