<script>
    ...
    onMount(() => {
        ...
        router.get('/api/assessment-subjects/' + assessmentId, {
            onSuccess : (res) => {
    ...
    const complete = () => {
        router.post('/api/assessment/termly/complete', { assessmentId, subjects: selectedSubjects, step : "complete_assessment" }, {
            onSuccess : (res) => {
